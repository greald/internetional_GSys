  ...
  <script>
    ...
    function add()
    {
      if ( document.getElementById('namekey').value == '') {
        alert(document.getElementById('namekey').value + ' namekey can t be anonymous'); return;
      }
    ...
    function more()
    {
      ...
      document.getElementById('innerHTML').placeholder = 'label / innerHTML';
      document.getElementById('generatedFormelements').value += "\n";
    ...
    function finish()
    {
      ...
      {
        alert(document.getElementById('instance').value + ' Formcontroller instance can t be anonymous'); return;
      }
...
//          '//echo "FormSetup.view.php hard 98 Fformid ";var_dump( \$Fformid );\n' +
        ...
        '{\n' +
//          '  '+ instance +'->' +
//          'viewfile( View::fakeEval('+ instance +'run), ' +
//          '[\$Fformid["name"]=>\$Fformid["value"]], $ext = ".view.php" ) ;\n' +
        '  '+ instance +'->' + 
        'viewfile(' + 
        'View::fakeEval('+ instance +'run),' + 
        '[ Formid::SCHERMNAMEN["formid"] => '+ instance +'->getFormid()["value"]],' + 
        '".view.php"' + 
        ') ;\n'+

        '}\n' + 
        'else {\n' + 
        '\$Fformid = (new Formid)->run();\n' + 
        'echo "\n<br/>"' + '.__FILE__.__LINE__." form processing with "; ' + 'var_dump('+ instance +'run) ;\n' +
        '}';
  ...
  <input type="checkbox" id="anonymous">don't send element's value to server<br/>
  ...
  <input type="text" id="innerHTML" placeholder="label / innerHTML" />
